<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<Authorization.Api.Models.AccountAuthorizeModel>" %>
...
<html>
    ...
    <body>
        ...
        <p>
            The <%: Model.Client.Client.Name%> application is requesting to access private
            data in your account.  By clicking 'Approve' below, you authorize <%: Model.Client.Client.Name %> to perform the following actions
        </p>
